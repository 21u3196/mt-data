    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm">
            ...
            <div class="max-w-lg space-y-4">
                ...
                <button type="button" onclick="proceedToPaymentSection()" class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-brand-600 to-accent-600 hover:from-brand-500 hover:to-accent-500 text-white font-extrabold text-base shadow-xl shadow-brand-500/25 hover:shadow-glow-brand transition-all flex items-center justify-center gap-3">
                    <span>Pay Now ₦<span class="pay-amount-label">0.00</span></span>
                    <i class="fa-solid fa-arrow-down text-sm animate-bounce"></i>
                </button>
            </div>
        </div>
            ...
            <div id="channelContentCard" class="space-y-6">
                <div class="max-w-lg mx-auto bg-slate-50/70 p-6 sm:p-8 rounded-3xl border border-slate-200/80 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-2xl border border-slate-200 bg-white focus-within:ring-2 focus-within:ring-brand-500 transition-all">
                            <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 text-sm">
                                <i class="fa-solid fa-credit-card"></i>
                            </span>
                            <input type="text" id="cardInputNumber" oninput="handleCardNumberInput(this)" maxlength="19" class="w-full pl-10 pr-4 py-3.5 rounded-2xl text-sm font-mono text-slate-900 placeholder-slate-400 bg-transparent border-0 focus:outline-none focus:ring-0" placeholder="Card Number (e.g. 5399 4100 1234 5678)" value="">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="cardInputExpiry" oninput="handleExpiryInput(this)" maxlength="5" class="w-full px-4 py-3.5 rounded-2xl text-sm font-mono border border-slate-200 text-slate-900 placeholder-slate-400 bg-white focus:ring-2 focus:ring-brand-500 focus:outline-none" placeholder="MM/YY" value="">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">CVV</label>
                            <input type="password" id="cardInputCvv" maxlength="4" class="w-full px-4 py-3.5 rounded-2xl text-sm font-mono border border-slate-200 text-slate-900 placeholder-slate-400 bg-white focus:ring-2 focus:ring-brand-500 focus:outline-none" placeholder="CVV" value="">
                        </div>
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Card 4-Digit PIN</label>
                        <input type="password" id="cardInputPin" maxlength="4" class="w-full px-4 py-3.5 rounded-2xl text-sm font-mono border border-slate-200 text-slate-900 placeholder-slate-400 bg-white focus:ring-2 focus:ring-brand-500 focus:outline-none" placeholder="4-Digit PIN" value="">
                    </div>

                    <!-- Card Action Button -->
                    <button type="button" onclick="startCardPaymentFlow()" class="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-brand-600 to-accent-600 hover:from-brand-500 hover:to-accent-500 text-white font-bold text-base shadow-xl shadow-brand-500/25 hover:shadow-glow-brand transition-all flex items-center justify-center gap-2 mt-2">
    ...
    <div class="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl border border-slate-100 text-center relative overflow-hidden">
        ...
        <div id="otpInputState" class="space-y-6">
            ...
            <div class="flex gap-3">
                ...
                <button type="button" onclick="submitFinalPayment('Card Payment')" class="flex-1 py-3 rounded-xl bg-gradient-to-r from-brand-600 to-accent-600 hover:from-brand-500 hover:to-accent-500 text-white text-xs font-bold shadow-md shadow-brand-500/20 transition-all flex items-center justify-center gap-1.5">
