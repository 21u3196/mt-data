...
<div class="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md bg-white rounded-3xl p-8 shadow-2xl border border-slate-100">
        ...
        <?php if ($purchase_success): ?>
            ...
            <a href="dashboard.php" class="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-brand-600 to-accent-600 text-white font-bold text-sm shadow-lg shadow-brand-500/25 hover:shadow-glow-brand transition-all flex items-center justify-center gap-2">
